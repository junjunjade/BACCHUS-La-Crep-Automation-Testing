...
Mobile.tap(findTestObject('Object Repository/Change PAX/android.widget.Button - PRINT BILL'), 0)

Mobile.tap(findTestObject('Object Repository/Change PAX/android.widget.Button - CONFIRM PRINT BILL'), 0)
