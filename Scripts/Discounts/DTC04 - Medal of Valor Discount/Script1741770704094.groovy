...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - BASIC CHOCOLATE CREPE'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - BASIC CREPE'), 0)
...
Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - Name'), 'Karl', 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - ID No'), '123456', 0)
