...
Mobile.scrollToText('Table 17', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(6)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 17'), 0)
...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - CHOCOLATE MOUSSE'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - TRIPLE CHOCOLATE CAKE SLICE'), 0)
...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - Chocolate Mousse in Added Item'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - ITEM PERCENT DC REGULAR'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - HOLD ORDER'), 0)

Mobile.delay(6)

Mobile.scrollToText("Table 17")
