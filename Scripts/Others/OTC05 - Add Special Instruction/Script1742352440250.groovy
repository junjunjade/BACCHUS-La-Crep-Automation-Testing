...
Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.TextView - TABLE 16'), 0)
...
Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - GB-BANANA WALNUT FRENCH TOAST'), 
    0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.TextView - GB-Banana Walnut French Toast'), 
    0)
...
Mobile.setText(findTestObject('Object Repository/Other Transactions/android.widget.EditText - Special Instruction'), 'add more sugar', 
    0)
