...
Mobile.scrollToText('Table 14', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(6)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.TextView - TABLE 14'), 0)
...
Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - CREPES SUCREES'), 0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - GB-BASIC CHOCOLATE CREPE'), 0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - EMMENTAL CHEESE'), 0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - GB-BASIC CREPE'), 0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - NEXT FIRST MENU'), 0)

Mobile.tap(findTestObject('Object Repository/Other Transactions/android.widget.Button - VOID TRANSACTION'), 0)
